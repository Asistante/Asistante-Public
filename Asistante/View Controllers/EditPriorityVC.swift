...
class EditPriorityVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "editTaskPriorityCell", for: indexPath)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        editTaskDelegate?.passPriority(priority: taskPriority)
        print ("Sent parameter priority from edit priority: \(taskPriority)")
